...
const downloadUrl =
  "https://github.com/NythralHome/globe/releases/download/v0.1.0-beta.10/Globe-0.1.0-beta.10.pkg";
    ...
    <main>
      ...
      <section className="hero" id="top">
        <div className="heroCopy">
          ...
          <p className="releaseNote">Beta 0.1.0-beta.10 for macOS 14 or newer.</p>
        </div>
